...
| 多机生产部署、Worker 横向扩展 | Linux + GPU 或 NPU | 源码安装、API/Worker 分离、外部 Redis | [源码安装 → API/Worker 分离](install-from-source.md#api-and-worker-split) 与 [部署](../deployment/index.md) |
...
- [部署](../deployment/index.md) —— 选择运行时拓扑。

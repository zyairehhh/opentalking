...
![WebUI 首屏：实时对话工作流、形象库和设置区](../../../assets/images/usage/webui-first-screen.png)
...
视频克隆的详细操作见[视频克隆](./video-clone.md)。
...
![WebUI 会话工作区：已选择 Avatar、模型和会话面板](../../../assets/images/quick-start/mock-first-session.png)
